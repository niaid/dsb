---
title: "topics - qualtile.clipping - scale.factor - Python and Bioc - multiplexing - multi batch - FAQ"
output: 
...
author: Matt Mulè
vignette: >
  %\VignetteIndexEntry{topics - qualtile.clipping - scale.factor - Python and Bioc - multiplexing - multi batch - FAQ}
...
We can extract the dsb technical component from this list for example:   
```{r}
