...
dsb (*d*enoised and *s*caled by *b*ackground)  is a lightweight R package for normalizing and denoising protein expression data from CITE-seq. The dsb package was developed in [John Tsang's Lab at the NIH-NIAID](https://www.niaid.nih.gov/research/john-tsang-phd) by Matt Mulè, Andrew Martins and John Tsang. 
