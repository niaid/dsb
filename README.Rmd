...
3. [**Speed up dsb 10-fold: set fast.km = TRUE (great for large datasets with / without empty droplets)**](https://cran.R-project.org/package=dsb/vignettes/fastkm.html) <br>
...
6. [**Frequently asked questions**](https://CRAN.R-project.org/package=dsb/vignettes/additional_topics.html) <br>
...
To speed up the function 10-fold with minimal impact on the results from those in the default function set `fast.km = TRUE` with either the `DSBNormalizeProtein` or `ModelNegativeADTnorm` functions. See the new [vignette](https://cran.R-project.org/package=dsb/vignettes/fastkm.html) on this topic. 
...
[Singhaviranon *Nature Immunology* 2025](https://doi.org/10.1038/s41590-024-02044-z) <br>
[Yayo *Nature* 2024](https://doi.org/10.1038/s41586-024-07944-6) <br>
