...
dsb is available on *CRAN* [latest dsb release on CRAN](https://CRAN.R-project.org/package=dsb). Install dsb in R with: `install.packages('dsb')`.  

A workflow tutorial is provided below. See the vignette tab on the CRAN dsb site for full tutorial: [Using dsb to normalize single cell protein data: analysis workflow and integration with Seurat, Bioconductor and Scanpy](https://CRAN.R-project.org/package=dsb)
...
Check the [news.md file](https://github.com/niaid/dsb/blob/master/NEWS.md) for recent updates.  
...
**dsb step by step detailed demonstration**
